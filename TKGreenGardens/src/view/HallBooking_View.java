...
public class HallBooking_View extends javax.swing.JInternalFrame {
     ...
     */
    public HallBooking_View(int booking_ID, String name, String date, String noOfPeople, String contactNumber, String address, String pack) {

        initComponents();
        jTextField2.setText(name);
        jTextField5.setText(date);
        jTextField10.setText(noOfPeople);
        jTextField8.setText(contactNumber);
